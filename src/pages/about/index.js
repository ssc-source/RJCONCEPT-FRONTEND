...
export default function AboutPage() {
  ...
  return (
    <>
      <Seo
        title="About Us"
        description="Learn about RJ Concept, Bihar's premier coaching institute for competitive exams. Meet our expert leadership team and understand our core educational values."
        schema={seoSchema}
      />
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-md border overflow-hidden mb-4">
                  <img 
                    ...
                    alt="Rahul Jha - Founder & Director at RJ Concept"
                    title="Rahul Jha - Founder & Director"
                    width={112}
                    height={112}
                    loading="lazy"
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-md border overflow-hidden mb-4">
                  <img 
                    ...
                    alt="Varsha Jha - CEO at RJ Concept"
                    title="Varsha Jha - CEO"
                    width={112}
                    height={112}
                    loading="lazy"
                    className="w-full h-full object-cover"
