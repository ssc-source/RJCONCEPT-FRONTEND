  ...
  return (
    <>
      <Seo
        ...
        description="Read the Privacy Policy of RJ Concept to learn how we collect, use, protect, and safeguard your personal and academic data."
        schema={seoSchema}
      />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg text-gray-700 space-y-6">
            ...
            <p>
              ...
              <strong> info@rjconcept.in</strong> or visit our center.
            </p>
          </div>
        </div>
      </div>
