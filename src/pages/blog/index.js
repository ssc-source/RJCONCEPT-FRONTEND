...
export default function BlogPage() {
  ...
  return (
    <>
      <Seo
        title="Blog & Exam Updates"
        description="Stay updated with the latest exam strategies, BPSC/UPSC study hacks, official exam notifications, and current affairs mock digests on the RJ Concept blog."
        schema={seoSchema}
      />

      <div className="bg-slate-50 min-h-[80vh] py-20 flex flex-col items-center justify-center">
        <div className="text-center">
          <span className="text-6xl mb-6 block" role="img" aria-label="Blog icon">📝</span>
