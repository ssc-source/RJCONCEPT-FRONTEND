...
export default function AdmissionsPage() {
  ...
  return (
    <>
      <Seo
        title="Admissions"
        description="Secure your seat at RJ Concept, Bihar's leading coaching institute. Request details on upcoming batches, fees structure, and free demo classes for UPSC, BPSC, SSC, and Banking exams."
        schema={seoSchema}
      />
